...
CMakeFiles/hello_test.dir/test/hello_test.cc.i: cmake_force
	...
	/usr/bin/clang++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/xy/BplusTree/test/hello_test.cc > CMakeFiles/hello_test.dir/test/hello_test.cc.i
...
CMakeFiles/hello_test.dir/test/hello_test.cc.s: cmake_force
	...
	/usr/bin/clang++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/xy/BplusTree/test/hello_test.cc -o CMakeFiles/hello_test.dir/test/hello_test.cc.s
...
hello_test: CMakeFiles/hello_test.dir/link.txt
	...
	/usr/bin/cmake -D TEST_TARGET=hello_test -D TEST_EXECUTABLE=/root/xy/BplusTree/build/hello_test -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/root/xy/BplusTree/build -D TEST_EXTRA_ARGS= -D TEST_PROPERTIES= -D TEST_PREFIX= -D TEST_SUFFIX= -D TEST_FILTER= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=hello_test_TESTS -D CTEST_FILE=/root/xy/BplusTree/build/hello_test[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=5 -D TEST_XML_OUTPUT_DIR= -P /usr/share/cmake-3.22/Modules/GoogleTestAddTests.cmake
...
CMakeFiles/hello_test.dir/depend:
	cd /root/xy/BplusTree/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/xy/BplusTree /root/xy/BplusTree /root/xy/BplusTree/build /root/xy/BplusTree/build /root/xy/BplusTree/build/CMakeFiles/hello_test.dir/DependInfo.cmake --color=$(COLOR)
